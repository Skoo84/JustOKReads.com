    ...
    if($result->num_rows > 0){
      ...
      while($r = mysqli_fetch_array($result)){
        echo "<tr> <td style='border:1px solid black;'>" .  $r['name'] .
          "</td><td style='border:1px solid black;'>" .  $r['title'] .
         "</td><td style='border:1px solid black;'>" . $r['description'] .
         "</td><td style='border:1px solid black;'>" . $r['rating'] . "</td></tr>";
        echo "<br>";
      }
      echo "</table>";
    }
...
<h3>Add a review</h3>
<form action="review.php?bookid=<?=$_GET['bookid']?>" method="post">
  ...
  <a href="modifydeletereview.php?bookid=<?=$_GET['bookid']?>"><button type="button">Modify/Delete review</button></a>
</form>
