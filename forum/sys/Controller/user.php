...
class user {
    ...
    public function profile($id, $action) {
        ...
        if ($user) {
            ...
            if ($action == 'edit' && $can_edit) {
                ...
                $this->smarty->assign('can_edit_profile', $this->can_edit_profile($uid));
    ...
    public function edit_profile($id_being_edited) {
        ...
        if (isset($_FILES) && $_FILES['avatar']['error'] != UPLOAD_ERR_NO_FILE) {
            ...
            $success = false;
            \CODOF\File\Upload::$width = Avatar::$heightWidthImage;
            \CODOF\File\Upload::$height = Avatar::$heightWidthImage;
