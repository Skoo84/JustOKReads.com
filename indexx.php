                    ...
                    <div class = "panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" id="releaseDate" placeholder="publisher's name" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="description" class="control-label col-sm-4"> Short description</label>
                                <div class="col-sm-12">
                                    <input type="text" id="description" placeholder="describe the book" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                    <div class="col-sm-12">
