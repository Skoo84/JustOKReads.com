...
class topic {
    ...
    public function reply() {
        ...
        if (isset($_POST['input_txt']) && isset($_POST['output_txt']) && isset($_POST['tid'])) {
            ...
            \CODOF\Hook::call('before_reply_insert');
    ...
    public function create() {
        ...
        if (isset($_POST['title']) && isset($_POST['cat']) && isset($_POST['imesg']) && isset($_POST['omesg'])) {
            ...
            \CODOF\Hook::call('before_topic_insert',[$_POST['title'],$_POST['imesg'],$tags]);
    ...
    public function edit() {
        ...
        if ($has_permission) {
            ...
            if (isset($_POST['title']) && isset($_POST['cat']) && isset($_POST['imesg']) && isset($_POST['omesg'])) {
                ...
                \CODOF\Hook::call('before_topic_edit',[$_POST['title'],$_POST['imesg'],$tags]);
