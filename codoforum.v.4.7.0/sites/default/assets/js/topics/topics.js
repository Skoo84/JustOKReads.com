...
CODOF.hook.add('on_oembed_loaded', function () {

    $('.codo_topics_topic_oembed_video .oembedall-container').each(function () {
...
jQuery('document').ready(function ($) {
    ...
    function toggleSwitch() {
        if($('#codo_sidebar_inf_scroll_switch').prop('checked')) {
    ...
    if(localStorage.getItem("infiniteScrollingSwitch") === 'switch_on') {
        $('#codo_sidebar_inf_scroll_switch').trigger('click'); //Assume off by default.
    }
