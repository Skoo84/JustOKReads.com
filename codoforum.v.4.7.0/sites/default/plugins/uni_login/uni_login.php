...
EOD;
        ...
        \CODOF\Plugin::storeContent('block_register_form_start', $html);
    }
...
CODOF\Hook::add('tpl_before_user_login', array($uni, "body"));
CODOF\Hook::add('tpl_before_user_register', array($uni, "head"));
CODOF\Hook::add('tpl_before_user_register', array($uni, "body"));
